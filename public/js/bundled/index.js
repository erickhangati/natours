...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "displayMapbox", ()=>displayMapbox);
const displayMapbox = (locations)=>{
    mapboxgl.accessToken = "pk.eyJ1IjoiZWtoYW5nYXRpIiwiYSI6ImNsNWo4YTg0cDBmazIzZHBsOHN3MG54aTYifQ.bkbk53VKr6JqQgrDRQhKCg";
...
const updateSettings = async (data, type)=>{
    try {
        ...
        if (res.data.status === "success") {
            (0, _alerts.showAlert)("success", `${type === "data" ? "Data" : "Password"} updated successfully.`);
            window.setTimeout(()=>{
...
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _alerts = require("./alerts");
const stripe = Stripe("pk_test_51LOHBLHi7CwhwoFLJHeVEPd5M1q39XQlsKF7EmeIyds7GkaDwLAVVTka1KWqj1vFwwOWh8Ywfi6eMoSaK9Y3jBm000HazB8Wj1");
